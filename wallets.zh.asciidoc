...
大部分HD钱包遵循BIP-32标准，这实际上已经成为了确定性密钥生成的行业标准。详细的规格说明请参照：https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki 这里我们不详细展开BIP-32，只讨论跟理解钱包使用相关的几点。网上各个软件库里有多个可操作的BIP-32应用。Consensys/eth-lightwallet 
